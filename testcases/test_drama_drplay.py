...
class TestDdrplay(unittest.TestCase):
    ...
    def test_drplay_drama(self):
        ...
        """
        # time.sleep(5)
        self.home.episode_button().click()  # 进剧集首页
        # time.sleep(5)
        # self.dramadr.mute_button().click()  # 开启小视频声音
        self.dramadr.moviecollect_button().click()  # 加入片单
    ...
    def test_drplay_details(self):
        ...
        self.home.episode_button().click()  # 进剧集首页
        # time.sleep(5)
        self.dramadr.details_button().click()  # 进每日推荐详情
